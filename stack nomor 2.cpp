...
main()
{
 printf("-------konversi desimal ke  bilangan biner octal dan heksa------\n");
 printf("------------------ DILLA SAFIRA / MI 2020B 20051397072-------------------\n");
 initializestack(&tumpukan);
 printf("\nmasukkan bilangan desimal = ");
 scanf("%d", &input);
 printf("\n---MENU---\n");
 printf("1 untuk konversi ke bilangan biner\n");
 printf("2 untuk konversi ke octal\n");
